...
/* initialize goomba */
extern void goomba_init(struct Goomba* goomba) {
  goomba->x = 200;
    goomba->y = 120;
...
extern void goomba_left(struct Goomba* goomba) {
    /* face left */
...
extern void goomba_update(struct Goomba* goomba) {
